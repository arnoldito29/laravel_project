...
export default {
    ...
    methods: {
        onChangeManufacturer(model = null) {
        ...
        retrieveTransport(id) {
            TransportService.get(id)
                .then(response => {
                    ...
                    console.log(response.data.data);
                    this.calculate();
                    this.selectManufacturer = this.transport.model.manufacturer.id;
                    this.onChangeManufacturer(this.transport.model.id)
                })
                .catch(e => {
                    console.log(e);
                });
        ...
        saveTransport() {
            ...
            TransportService.update(this.transport.id, data)
                .then(response => {
    ...
    mounted() {
        ...
        this.retrieveTransport(this.$route.params.id);
    }
};
</script>
